...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler(InstituteManagementSystemException.class)
	public ResponseEntity<MyErrorDetails> InstituteManagementSystemException(InstituteManagementSystemException se,WebRequest wr){
